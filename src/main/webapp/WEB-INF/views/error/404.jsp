...
<head>
	...
	<style type="text/css">
		...
		.list li{list-style-type:none;margin-left:-1rem}
...
<body>
    <h1></h1>
    <h2>
    	<em><span class="STYLE1">404 Error&nbsp;&nbsp; </span></em>: 您所查找的页面不存在,可能已被删除或您输错了网址!
    </h2>
    <div style="padding-left:10rem">
	    ...
	    <dl class="texts">
	        <dt>您将要访问的页面不存在或者已被删除,您可以选择</dt>
			<dd>
	            <ul class="list">
	                <li><a href="${basePath}">&#9666;返回首页</a></li>
	                <li><a href="javascript:history.go(-1);">&#9666;返回上一页</a></li>
	                <li><a href="javascript:void(0);">&#9666;联系管理员</a></li>
	                <li><a href="javascript:window.close();">&#9666;关闭页面</a></li>
	            </ul>
	        </dd>
	    </dl>
    </div>
