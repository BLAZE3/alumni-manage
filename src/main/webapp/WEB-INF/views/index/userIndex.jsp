			...
			<ul class="nav nav-list">
				<c:choose>
					<c:when test="${user.type=='2'}">
						<li class="active">
							<a href="studentInfo/forwardStudentRegister" target="frame-content">
								<i class="icon-desktop"></i>
								<span class="menu-text"> 学生信息认证 </span>
							</a>
						</li>
					</c:when>
					<c:when test="${user.type=='3'}">
						<li class="active">
							<a href="javascript:void(0);">
								<i class="icon-desktop"></i>
								<span class="menu-text"> 学生信息(认证中) </span>
							</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class="active">
							<a href="studentInfo/forwardStudentInfoUpdate?userId=${loginUser.id}" target="frame-content">
								<i class="icon-desktop"></i>
