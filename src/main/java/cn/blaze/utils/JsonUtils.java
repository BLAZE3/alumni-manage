 ...
 * @Description json工具类
 * @author LiuLei
 * @date 2017年4月26日 下午9:30:11
 */
public class JsonUtils {

    public static final String responseSuccessMessage() {
    ...
    public static final String responseErrorMessage(String msg) {
        StringBuilder sb = new StringBuilder();
        sb.append("{\"message\":\"");
        sb.append(msg);
